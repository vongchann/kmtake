...
class InOrOut:
    ...
    def __init__(
        ...
        if self.source_dirs or self.source_pkgs:
            ...
            if self.pylib_paths:
                self.pylib_match = TreeMatcher(
                    self.pylib_paths, "pylib", "Python stdlib", _debug
                )
        if self.include:
        ...
        self.cover_match = TreeMatcher(
            self.cover_paths, "coverage", "Coverage code", _debug
        )

        self.third_match = TreeMatcher(
            self.third_paths, "third", "Third-party lib", _debug
        )
        ...
        self.source_in_third_match = TreeMatcher(
            self.source_in_third_paths,
            "source_in_third",
            "Source in third-party",
            _debug,
        )
